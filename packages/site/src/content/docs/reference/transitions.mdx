...
<StateChart
  ...
  transitions={[
    ...
    { from: 'reattemptConnection', to: 'connecting', label: '(after delay ) CONNECT' },
...
For *homogenous* state-data you also have the option to set `enableCopyDataOnTransition: true` to avoid some boilerplate. See the [states](/reference/state/) documentation for a longer discussion.
