...
<Aside type="tip">
  View this example's{" "}
  <a
    href="https://github.com/maurice/yay-machine/blob/main/packages/example-machines/src/priceMachine.ts"
    target="_blank"
  >
    source
  </a>{" "}
  and{" "}
  <a
    href="https://github.com/maurice/yay-machine/blob/main/packages/example-machines/src/__tests__/priceMachine.test.ts"
    target="_blank"
  >
    test
  </a>{" "}
...
<Aside type="tip">
  View this example's{" "}
  <a
    href="https://github.com/maurice/yay-machine/blob/main/packages/example-machines/src/tickerMachine.ts"
    target="_blank"
  >
    source
  </a>{" "}
  and{" "}
  <a
    href="https://github.com/maurice/yay-machine/blob/main/packages/example-machines/src/__tests__/tickerMachine.test.ts"
    target="_blank"
  >
    test
  </a>{" "}
