...
First, let's define all the **states**, **events** and **transitions** of the state-machine first. Let's ignore _state-data_ and _event-payloads_ right now.
  ...
  <StateChart
    ...
    transitions={[
      ...
      { from: "validateWithdrawal", to: "enterPin", label: "INCORRECT_PIN" },
      {
        from: "validateWithdrawal",
        to: "ejectCard",
        label: "INCORRECT_PIN (too many attempts)",
      },
      {
        from: "validateWithdrawal",
        to: "ejectCard",
