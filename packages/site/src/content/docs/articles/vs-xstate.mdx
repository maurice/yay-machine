...
Read more about [our philosophy here](./why-yay-machine#philosophy).
...
| Visualizer | <Y/> | <N/>    |
| Online editor | <Y/> | <N/>    |
| View library bindings (React, Vue, Svelte) | <Y/> | <P/> <sup>(planned)</sup> |
| Docs | <Y/> | <Y/> <sup>(more to come)</sup> |

## State-machine/chart features at a glance

|          | **XState** | **yay-machine** |
| -------- | -------- | ------- |
| Flat state-machines | <Y/> | <Y/>    |
| Declarative JSON configuration | <Y/> | <Y/>    |
| Create independent machine instances | <Y/> | <Y/>    |
| Initial state (and context/state-data) overridable per machine-instance | <Y/> | <Y/> |
| Machine instance lifecycle: subscribe-to, start, send events, and stop | <Y/> | <Y/>    |
| Context | <Y/> | <Y/> <sup>(equivalent: [state data](../reference/state/))</sup> |
| Actions | <Y/> | <Y/> <sup>(equivalent: [side-effects](../reference/side-effects/))</sup> |
| Invoke/spawn Actors within machine | <Y/> | <Y/> <sup>(equivalent: [side-effects](../reference/side-effects/))</sup> |
| Native `Promise`, `Observable`, `EventObservable` Actors | <Y/> | <Q/> <sup>(not native, but easily done)</sup> |
| Eventless (always) transitions | <Y/> | <Y/> |
| Delayed (after) transitions | <Y/> | <Q/> <sup>(easy via [side-effect](../reference/side-effects/) + `setTimeout()`)</sup> |
| Guards (conditional transitions) | <Y/> | <Y/> |
| Reenter (aka internal) transitions | <Y/> | <Y/> |
| Parent/child states | <Y/> | <N/> <sup>(not yet, for now just flatten them)</sup> |
| Parallel states | <Y/> | <N/> <sup>(not yet, for now compose child machines)</sup> |
| Final states | <Y/> | <N/> <sup>(nothing formal)</sup> |
| History states | <Y/> | <X/> <sup>(not a project goal)</sup> |
| Persistence (serialization/deserialization) | <Y/> | <X/> <sup>(not a project goal)</sup> |
| SCXML | <Y/> | <X/> <sup>(not a project goal)</sup> |
